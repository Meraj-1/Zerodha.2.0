...
function Stats() {
  return (
    <div className='container mx-auto px-15 mt-20'>
      <div className='flex flex-wrap justify-center'>
        <div className='w-full lg:w-1/2 mt-10 mb-8 '>
          <h1 className='text-3xl md:text-3xl font-bold m-3 sm:m-4'>Trust with confidence</h1>
          <h4 className='text-xl font-bold mt-10 m-4'>Customer-first always</h4>
          <p className='text-gray-900 sm:mb-4 m-4'>
            That's why 1.5+ crore customers trust Zerodha with ₹4.5+ lakh crores of equity investments and contribute to 15% of daily retail exchange volumes in India.
          </p>
          <h4 className='text-xl font-bold m-4'>No spam or gimmicks</h4>
          <p className='text-gray-700 m-4'>
            No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like.
          </p>
          <h4 className='text-xl font-bold m-4'>The Zerodha universe</h4>
          <p className='text-gray-700 m-4'>
            Not just an app, but a whole ecosystem. Our investments in 30+ fintech startups offer you tailored services specific to your needs. 
            Do better with money.
          </p>
          <h4 className='text-xl font-bold m-4'>Do better with money</h4>
          <p className='text-gray-700  m-4'>
            With initiatives like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with your money.
          </p>
        </div>
        <div className='lg:w-1/2  flex flex-col items-center mb-8'>
          <img
            id='img-home-main'
            src='https://zerodha.com/static/images/ecosystem.png'
            alt='Ecosystem'
