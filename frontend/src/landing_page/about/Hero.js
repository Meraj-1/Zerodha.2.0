...
//             <p className='text-gray-700 mb-4'>We kick-started operations on the 15th of August, 2010
...
//               barrier.</p>
//             <p className='text-gray-700 mb-4'>Today, our disruptive pricing models and in-house
//               technology have made us the biggest stock broker in
//               India.</p>
//             <p className='text-gray-700 mb-4'>Over 1+ Crore clients place millions of orders every day
//               through our powerful ecosystem of investment 
//               platforms, contributing over 15% of all Indian retail
//               trading volumes.</p>
//           </div>
//           <div className='flex-1 p-4'>
//             <p className='text-gray-700 mb-4'>In addition, we run a number of popular open online
//               educational and community initiatives to empower retail
//               traders and investors.</p>
//             <p className='text-gray-700 mb-4'>Rainmatter, our fintech fund and incubator, has invested
//               in several fintech startups with the goal of growing the
//               Indian capital markets.</p>
//             <p className='text-gray-700 mb-4'>And yet, we are always up to something new every day.
